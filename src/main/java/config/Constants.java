...
public class Constants {
	//System Variables
		public static final String URL = "https://connect.kloudu.net/";
		public static final String Path_TestData = "src/main/resources/dataEngine/DataEngine.xlsx";
		...
		// Test Data
		public static final String UserName = "EtharMahmoud";
